...
- Similar to the notebook, but the functions are evaluated directly on an HTML page. Not quite as user-friendly as the notebook, but without the need for any installation. For a quick [lookup](https://peterluschny.github.io/tablInspector/InteractiveTablInspector.html). Try it out.
